    ...
    <figure class="card card-product-grid card-lg"> 
        <figcaption class="info-wrap">
            <div class="row d-flex justify-content-center">
                <div class="col-md-9 col-xs-9"> <h3 class="title" data-abc="true"><a href="{{ route('showReservation', ['id' => $reservation->id])}}"><b>Reservation: {{$reservation->id}}</b></a></h3> <p class="rated"> {{$reservation->user->name}}</p> </div>
        ...
        <div class="bottom-wrap-payment">
            <figcaption class="info-wrap">
                <div class="row d-flex justify-content-center">
                    <div class="col-md-9 col-xs-9"> <a href="#" class="title" data-abc="true"> {{$reservation->dt_start}}</a> <p class="rated">{{$reservation->time_res}} hour</p> </div>
