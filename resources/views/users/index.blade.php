    ...
    <figure class="card card-product-grid card-lg"> 
        <figcaption class="info-wrap">
            <div class="row d-flex justify-content-center">
                <div class="col-md-9 col-xs-9"> <h3 class="title" data-abc="true">{{$user->name}}</h3> <span class="rated">{{$user->adress}}</span> </div>
        ...
        <div class="bottom-wrap-payment">
            <figcaption class="info-wrap">
                <div class="row d-flex justify-content-center">
                    <div class="col-md-9 col-xs-9"> <a href="#" class="title" data-abc="true">{{$user->role}}</a> <span class="rated">{{$user->phone}}</span> </div>
        ...
        <div class="btns ">
          ...
          <div class="bottom-wrap d-flex justify-content-start"> <a href="{{ route('editUser', ['id' => $user->id])}}" class="btn btn-primary float-right" data-abc="true"> Edit </a>
          <div class="price-wrap d-flex justify-content-end"> 
            <form action="/users/{{$user->id}}" method="post">
               @csrf
               @method('DELETE')
              <button class="btn btn-danger float-left" data-abc="true"> Delete</button> 
              </form>
             </div>
        </div>
        </div>
