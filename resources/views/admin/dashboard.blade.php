...
<body>
    <div id="app">
        <aside class="sidebar">
            ...
            <div class="side-menu">
                <a href="/dashboard">
                    <box-icon name='dashboard' type='solid' color="#EFF2FF"></box-icon>
                    <h2>Dashboard</h2>
                </a>
                <a href="/users">
                    <box-icon name='user' color="#EFF2FF"></box-icon>
                    <h2>Users</h2>
                </a>
                <a href="/statistics">
                    <box-icon name='bar-chart' color="#EFF2FF"></box-icon>
                    <h2>Statistic</h2>
                </a>
                @guest
                @if (Route::has('login'))
        ...
        <section class="container">
            <div class="username">
                <a href="{{ route('profile')}}" class="nav-link  second-text ms-auto fw-bold" id="navbar" d aria-expanded="false">
            ...
            <div class="reservation">
                <table>
                    ...
                    <tr class="rtable">
                        ...
                        <td><a href="{{ route('showReservation', ['id' => $reservation->id])}}">
